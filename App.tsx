...
type AppState = 
  ...
  | { view: 'formulario'; pessoaId: number; pessoaNome: string };
...
export default function App() {
  ...
  const navegarParaFormulario = (pessoaId: number, pessoaNome: string) => {
    setAppState({ view: 'formulario', pessoaId, pessoaNome });
  };
          ...
          <div className="relative container mx-auto px-4 py-16">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight">
                Ajude-nos a
                <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> encontrar </span>
                quem precisamos
              </h1>
              
              <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Sua informação pode ser a peça que falta para reunir uma família. 
                Consulte registros e contribua com dados que podem salvar vidas.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                <div className="bg-white/80 backdrop-blur-sm border border-white/60 rounded-xl p-6 shadow-lg">
                  ...
                  <h3 className="font-semibold text-slate-900 mb-2">Dados Oficiais</h3>
                  <p className="text-slate-600 text-sm">Informações verificadas pela Polícia Civil de MT</p>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm border border-white/60 rounded-xl p-6 shadow-lg">
                  ...
                  <h3 className="font-semibold text-slate-900 mb-2">Suporte 24h</h3>
                  <p className="text-slate-600 text-sm">Atendimento emergencial através do 197</p>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm border border-white/60 rounded-xl p-6 shadow-lg">
                  ...
                  <h3 className="font-semibold text-slate-900 mb-2">Envio Seguro</h3>
                  <p className="text-slate-600 text-sm">Suas informações são tratadas com confidencialidade</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <main className="relative">
        ...
        {appState.view === 'detalhes' && (
          <PessoaDetalhes
            ...
            onEnviarInformacao={(pessoaId: number, pessoaNome: string) => {
              navegarParaFormulario(pessoaId, pessoaNome);
            }}
          />
        )}
        ...
        <div className="relative">
          ...
          <div className="container mx-auto px-4 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-12">
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">Pessoas Desaparecidas</p>
                  </div>
                </div>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Trabalhamos incansavelmente para reunir famílias e trazer esperança 
                  através da tecnologia e colaboração da sociedade.
                </p>
              </div>
              
              {/* Emergency Contacts */}
              <div className="space-y-4">
                <h3 className="font-semibold text-lg mb-6 text-white">Contatos de Emergência</h3>
              ...
              {/* System Info */}
              <div className="space-y-4">
                <h3 className="font-semibold text-lg mb-6 text-white">Informações do Sistema</h3>
              ...
              {/* Help Section */}
              <div className="space-y-4">
                <h3 className="font-semibold text-lg mb-6 text-white">Como Contribuir</h3>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-blue-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-blue-400 text-xs font-bold">1</span>
                    </div>
                    <p className="text-slate-300 text-sm">Compartilhe apenas informações verdadeiras e relevantes</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-slate-300 text-sm">Entre em contato imediatamente com a polícia se tiver informações</p>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-slate-300 text-sm">Divulgue casos em suas redes sociais responsavelmente</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="text-center md:text-left">
                  <p className="text-slate-400 text-sm">
                    © 2025 Polícia Civil do Estado de Mato Grosso. Todos os direitos reservados.
                  </p>
